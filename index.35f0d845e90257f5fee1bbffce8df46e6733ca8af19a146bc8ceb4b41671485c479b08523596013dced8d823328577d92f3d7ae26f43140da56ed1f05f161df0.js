  ...
  index.add(
    {
      ...
      .add(
      {
        ...
        content: "rbacrole based accessSAMLjit saml user provisioningThis document will describe how to create and assign roles in Azure AD so that the role can be passed along during SAML login to BluBracket for the purpose of JIT user provisioning. If you are not interested in JIT user provisioning during SAML please skip this document. Special roles are not required for regular SAML login functionality.\nBefore proceeding with setting up SAML roles, please ensure that you have configured SAML login on your BluBracket tenant (please see Configure Azure AD for further details).\nCreating a new Applicaiton role in the BluBracket App # The next step is to create a new role for the BluBracket application:\nUnder Enterprise Applications | BluBracket, select the App roles item. Then click the Create app role button.\nIn the Dialog box that appears fill out the following:\n In the Display name box, type a name for this role (the name can be anything that seems logical to your organization) Under allowed members types, select the Both radio button In the Value field, type a value for the permission we will be granting to this role (the permission can be anything, make not of the value as BluBracket support will later need the value to configure the role mapping) In the Description box type in any description that will remind you about the purpose of thise role. Do you want to enable this app role should be selected as enabled.    Once all of the above is filled out, click Apply for the role to be created.\nAt this point you have created a new custom role for the BluBracket Application. Please remember to send BluBracket Support the value you used above for the Value field as this will essential for BluBracket Support to map your roles to BluBracket roles.\nAdding an Azure group to the BluBracket App # The next step is to add a group to an application, and assign a role to the group.\n Under Enterprise Applications | BluBracket, select the Users and groups item. Then click on Add user/group.   Under users and groups, click on None Selected. In the dialog box, search for a pre-existing group which you would like to add to the BluBracket application. (Note that the members of this group will later be granted permission to login to BluBracket via SAML). Once you have found the group click on that group, and then click on the Select button to confirm the selection.   Next, under Select a role, select the None Selected. In the dialog box that appears find the name of the application role that you had created previously in this document. Select that role. Then click on the Select button to confirm the selection.   Finally Select the Assign button to complete the assingment of this group and role to the BluBracket application.    At this point you have completed assigning a new group, with the given role assigned to the BluBracket Application.\n"
      ...
      .add(
      {
        ...
        content: "In order for BluBracket to access information on the Gerrit code review host, HTTP credentials must be generated.\nGenerating HTTP credentials #  Once signed in to Gerrit, click the icon in the upper-right hand corner to see the settings dropdown.     Scroll down to the HTTP credentials section of the user settings page.     Click \u0026ldquo;Generate New Password\u0026rdquo; for the new HTTP credentials.    Entering username and HTTP credentials # A username and HTTP credentials are necessary for BluBracket to access the Gerrit code review host.\n See the username in the profile section of the user settings page.     After generating the HTTP credentials and taking note of the username, enter them into BluBracket.    "
      ...
      .add(
      {
        ...
        content: "microsoft teamsRequirements #  Generate a Microsoft Teams channel Incoming WebHook   Creating a Microsoft Teams Connection #   Navigate to Microsoft Teams integrations by clicking the Microsoft Teams link on the integrations page.    Begin creating a BluBracket Microsoft Teams connection by clicking the + CONNECTION button.    Copy the Incoming WebHook URL generated in Microsoft Teams App   Paste the Incoming WebHook URL into the token input and click TEST \u0026amp; SAVE.    Now you\u0026rsquo;re ready to create subscriptions for this connection and start seeing BluBracket notifications in Microsoft Teams.\n"
      ...
      .add(
      {
        ...
        content: "integrationsmessagingmicrosoft teams BluBracket integration with Microsoft Teams can alert teams about code risks in new commits in real time.\n  Requirements # Integration with Microsoft Teams requires the following:\n   Create a Microsoft Teams connection    Create a Microsoft Teams subscription   "
      ...
      .add(
      {
        ...
        content: "microsoft teamsRequirements #  Generate a Microsoft Teams channel Incoming WebHook  Create a Microsoft Teams connection   Creating a Microsoft Teams Subscription #   Navigate to Microsoft Teams integrations by clicking the Microsoft Teams link on the integrations page    Click the + SUBSCRIPTION button to begin the creation process.    Choose a name for the subscription as well as the saved filters you would like the subscription to be based on.\n  Choose the connection for the subscription output.\n  Click SAVE    BluBracket events matching your filters will be sent to your specified channel in Microsoft Teams.\n"
      ...
      .add(
      {
        ...
        content: "splunkRequirements #   Splunk integration token   Creating a Splunk Connection #   Navigate to Splunk integrations by clicking the Splunk link on the integrations page    Begin creating a BluBracket Splunk connection by clicking the + CONNECTION button    Enter a unique name for the connection.\n  Generate an integration token following the Splunk docs   Copy your integration token and paste it into the token field.\n  Enter the port number (default is 8088).\n  If you are testing with a free trial, check the optional box.\n  Enter the base url of your splunk account.\n  Click TEST \u0026amp; SAVE.    Now you\u0026rsquo;re ready to create subscriptions for this connection and start seeing BluBracket incidents in Splunk.\n"
      ...
      .add(
      {
        ...
        content: "integrationsSplunkincident management BluBracket can automatically create a Splunk events when risks are found in new commits.\n  Requirements # Integration with Splunk requires the following:\n   Create a Splunk connection    Create a Splunk subscription   "
      ...
      .add(
      {
        ...
        content: "splunkRequirements #  Created a Splunk connection   Creating a Splunk Subscription #   Navigate to Splunk integrations by clicking the Splunk link on the integrations page.    Click the + SUBSCRIPTION button to begin the creation process.    Choose a name for the subscription as well as the saved filters you would like the subscription to be based on.\n  Choose the connection for the subscription output.\n  Enter the Splunk index.\n  Enter a Splunk source type.\n  Click SAVE    BluBracket events matching your filters will create events in the specified Splunk index.\n"
      ...
      .add(
      {
        ...
        content: "pagerdutyCreating a PagerDuty Connection #   Navigate to PagerDuty integrations by clicking the PagerDuty link on the integrations page    Begin creating a BluBracket PagerDuty connection by clicking the + CONNECTION button    Enter a unique name for the connection\n  Generate an API access key following the PagerDuty docs   Copy your API key and paste it into the API access key field\n  Click TEST \u0026amp; SAVE.    Now you\u0026rsquo;re ready to create subscriptions for this connection and start seeing BluBracket incidents in PagerDuty.\n"
      ...
      .add(
      {
        ...
        content: "pagerdutyPagerDuty Service Integration Key #   Navigate to Services by clicking the tab at the top of the page    Locate the service you want to integrate with and click the more dropdown    Select the View Integrations option    Locate and copy the Integration Key for the service    Now you\u0026rsquo;re ready to create subscriptions for this service.\n"
      ...
      .add(
      {
        ...
        content: "pagerdutyRequirements #  Created a PagerDuty connection  Have an existing PagerDuty Service   Creating a PagerDuty Subscription #   Navigate to PagerDuty integrations by clicking the PagerDuty link on the integrations page.    Click the + SUBSCRIPTION button to begin the creation process.    Choose a name for the subscription as well as the saved filters you would like the subscription to be based on.\n  Choose the connection for the subscription output.\n  Copy the desired PagerDuty service API key and paste it into the Integration Key field. If you need help locationg the key, you can follow these instructions .\n  Click SAVE    BluBracket events matching your filters will create incidents in the specified PagerDuty service.\n"
      ...
      .add(
      {
        ...
        content: "servicenowCreating a ServiceNow Connection #   Navigate to ServiceNow integrations by clicking the ServiceNow link on the integrations page    Begin creating a BluBracket ServiceNow connection by clicking the + CONNECTION button    Enter a unique name for the connection\n  Enter the username of a ServiceNow user with access to the desired account\n  Enter the password for the username in step 4\n  Enter the base URL of the account\n  Click TEST \u0026amp; SAVE.    Now you\u0026rsquo;re ready to create subscriptions for this connection and start seeing BluBracket tickets in ServiceNow.\n"
      ...
      .add(
      {
        ...
        content: "servicenowRequirements #  Begin creating a ServiceNow subscription   ServiceNow Custom Fields # BluBracket integration with ServiceNow supports adding custom fields that are used to create the tickets.\n These key-value pairs are supplied directly to the ServiceNow API. By default BluBracket is already sending the following fields:\n short_description description contact_type category subcategory  For a list of potential fields to supply, view the ServiceNow incident docs "
      ...
      .add(
      {
        ...
        content: "servicenowRequirements #  Created a ServiceNow connection   Creating a ServiceNow Subscription #   Navigate to ServiceNow integrations by clicking the ServiceNow link on the integrations page    Click the + SUBSCRIPTION button to begin the creation process.    Choose a name for the subscription as well as the saved filters you would like the subscription to be based on.\n  Choose the connection for the subscription output.\n  (Optional) Enter any custom field you wish to supply\n  Click SAVE    BluBracket events matching your filters will create tickets in the specified ServiceNow project.\n"
      ...
      .add(
      {
        ...
        content: "jiraRequirements #    Atlassian API Token    Jira Base URL    Jira Project for events and alerts to be added to.   Creating a Jira Connection #   Navigate to Jira integrations by clicking the Jira link on the integrations page    Begin creating a BluBracket Jira connection by clicking the + CONNECTION button    Create an Atlassian API Token   Paste the API token into the token input.\n  Enter the email of the user used to generate the Atlassian API Token   Enter the Jira Base URL   Click TEST \u0026amp; SAVE.    Now you\u0026rsquo;re ready to create subscriptions for this connection and start seeing BluBracket tickets in Jira.\n"
      ...
      .add(
      {
        ...
        content: "jiraRequirements #  Created a Jira connection   Creating a Jira Subscription #   Navigate to Jira integrations by clicking the Jira link on the integrations page    Click the + SUBSCRIPTION button to begin the creation process.    Choose a name for the subscription as well as the saved filters you would like the subscription to be based on.\n  Choose the connection for the subscription output.\n  Enter the Jira project key\n The project key can be found after /projects/ in the url example.atlassian.net/jira/software/c/projects/ENG    Enter the Jira issue type\n  Enter the Jira assignee id\n The assignee id can be found after selecting a user filter at the end of the url: example.atlassian.net/\u0026hellip;/assignee=5e6e72063e42490c3801493c    Enter the Priority\n  Click SAVE    BluBracket events matching your filters will create tickets in the specified Jira project.\n"
      ...
      .add(
      {
        ...
        content: "slackRequirements #  Created a BluBracket Slack App and installed to your workspace. Created a Slack connection   Creating a Slack Subscription #   Navigate to Slack integrations by clicking the Slack link on the integrations page    Click the + SUBSCRIPTION button to begin the creation process.    Choose a name for the subscription as well as the saved filters you would like the subscription to be based on.\n  Choose the connection for the subscription output and the slack channel.\n  Click SAVE    BluBracket events matching your filters will be sent to your specified channel in Slack.\n"
      ...
      .add(
      {
        ...
        content: "integrationsticketingJira BluBracket can automatically create a Jira ticket when risks are found in new commits.\n  Requirements # Integration with Jira requires the following:\n   Create a Jira connection    Create a Jira subscription   "
      ...
      .add(
      {
        ...
        content: "integrationsPagerDutyincident management BluBracket can automatically create a PagerDuty incidents when risks are found in new commits.\n  Requirements # Integration with PagerDuty requires the following:\n   Create a PagerDuty connection    Create a PagerDuty subscription   "
      ...
      .add(
      {
        ...
        content: "integrationsticketingServiceNow BluBracket can automatically create a ServiceNow ticket when risks are found in new commits.\n  Requirements # Integration with ServiceNow requires the following:\n   Create a ServiceNow connection    Create a ServiceNow subscription   "
      ...
      .add(
      {
        ...
        content: "integrationsincident managementBluBracket supports PagerDuty integration to automatically create incidents for alerts matching filters you can specify.\n"
