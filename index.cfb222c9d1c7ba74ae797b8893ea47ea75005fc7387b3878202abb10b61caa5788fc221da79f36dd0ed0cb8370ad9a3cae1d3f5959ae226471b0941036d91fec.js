  ...
  index.add(
    {
      ...
      .add(
      {
        ...
        description: "Requirements #  Create Jira connection   Creating a Jira Subscription #   Navigate to Jira integrations by clicking the Jira link on the integrations page    Click the + SUBSCRIPTION button to begin the creation process.    Choose a name for the subscription as well as the saved filters you would like the subscription to be based on.\n  Choose the connection for the subscription output and the Jira channel.",
