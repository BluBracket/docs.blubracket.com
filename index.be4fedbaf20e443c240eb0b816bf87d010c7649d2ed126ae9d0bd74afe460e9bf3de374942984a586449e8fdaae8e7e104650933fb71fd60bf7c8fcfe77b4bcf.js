  ...
  index.add(
    {
      ...
      .add(
      {
        ...
        title: "Integrations",
        description: "Local workflow tools # [screenshot: pre-commit check via CLI tool]\nAvailable local tools and integrations\n CLI IntelliJ (via CLI, full plugin coming soon) VS Code (via CLI)  Code servers # [screenshot: list of repos imported and scanned in BluBracket]\nCertified \u0026amp; supported code servers:\n GitHub GitLab Bitbucket Azure DevOps (contact us for beta) Gerrit (coming soon)  CI servers # [screenshot: GitHub check]\nCertified \u0026amp; supported CI servers:",
        content: "Local workflow tools # [screenshot: pre-commit check via CLI tool]\nAvailable local tools and integrations\n CLI IntelliJ (via CLI, full plugin coming soon) VS Code (via CLI)  Code servers # [screenshot: list of repos imported and scanned in BluBracket]\nCertified \u0026amp; supported code servers:\n GitHub GitLab Bitbucket Azure DevOps (contact us for beta) Gerrit (coming soon)  CI servers # [screenshot: GitHub check]\nCertified \u0026amp; supported CI servers:\n GitHub Checks Bitbucket Code Insights Jenkins  Additional integrations are available via our open CI API.\nIdentity, authentication, and authorization # [screenshot: SAML sign-in]\nCertified \u0026amp; supported identity integrations:\n Azure AD Okta Ping SAML GitHub OAuth (coming soon) Gitlab OAuth (coming soon) Bitbucket OAuth (coming soon)  Messaging # [screenshot: alert via Slack]\nCertified \u0026amp; supported messaging integrations:\n Slack Microsoft Teams  Ticketing \u0026amp; incident management # [screenshot: Jira ticket created from alert]\nCertified \u0026amp; supported ticketing \u0026amp; incident management integrations:\n Jira ServiceNow PagerDuty Splunk  Build your own #  APIs Webhooks (coming soon)  "
      })
      .add(
      {
        id: 42,
